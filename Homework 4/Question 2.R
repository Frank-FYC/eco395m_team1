...
library(plotly)
library(GGally)
socialdata<-'https://raw.githubusercontent.com/jgscott/ECO395M/master/data/social_marketing.csv'
##protein <- read.csv(url(socialdata), row.names=1)
#36 different categories
SocialMarket <- read.csv(url(socialdata), row.names=1)
