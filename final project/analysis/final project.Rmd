...
# Abstract
With recent budget cuts in the Federal allocation of funds to the Department of Education, the age old debate on the efficacy of Head Start program resurfaced. We use David Deming's data collected from the National Longitudinal Survey of Youth(NLSY'79) as our baseline data and explore if there are any short term and/or long term benefits of participating in Head Start program for kids from socio-economically disadvantaged backgrounds. We see that there is a statistically significant negative effect of Head Start on the kids composite score at ages 6 to 11. Although there is a positive effect of Head Start on composite scores in later ages, this effect is statistically insignficant. We also see that there is a negative effect of Head Start on the PPVT scores at the age of 3. This makes sense, as the kids eligible for Head Start would have lower PPVT scores when compared to the others. Head Start also implies lower probability of grade repetition. We do however see positive effect of Head Start on long term outcomes such as High School Graduation, College enrollment and better Health conditions.
...
The odds of a Head Start participant ever repeating a grade as compared to a non Head Start participant is 0.924 and significant (p-value <0.05), while controlling for other variables. This odds ratio is even lower for Hispanics who attend Head Start program, however, Black children who attend Head Start have an odds ratio of 1.265 as compared to their non Head Start counterparts. This shows that Head Start participants in general have lower probabilities of repeating a grade as compared to non Head Start participants.
...
The odds ratio of Head Start participants who are *Idle* are compared to non Head Start participants. The odds ratio of Head Start participants seem to follow a similar pattern as the self-reported Poor Health. Head Start participants in general are less likely than non Head Start particpants to be idle. However, when controlled for Head Start interactions with race, Hispanic and Black Head Start participants are less likely to be idle compared to their non Head Start counterparts. However, White Headstart participants are just as likely to be idle compared to their non Head Start counterparts.

# Conclusion

We are aware of the limitations of both our dataset and our analysis of it. The dataset we use has enough oservations to account for the short term benefits, however, it only has data until 2004. The NLSY'79 has now data upto the year 2016, which would give us a larger dataset to measure long term outcomes more efficiently. We also use linear and logit models to estimate the effects. However, there are multiple variables that we don't account for such as fixed effects of belonging to the same family, clustering errors, etc. If we had more time, we would have liked to explore the effect of Head Start on other long term outcomes such as whether they get married, divorce rates, income levels, credit scores, home ownership, etc.
